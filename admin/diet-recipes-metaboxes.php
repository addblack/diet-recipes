...
function diet_recipes_short_description_box_callback($post)
{
	...
	?>
    <label for="diet_recipes_short_description_field">Here you can add some description for your recipe (Up to 163
        symbols)</label>
    <textarea name="diet_recipes_short_description_field" id="diet_recipes_short_description_field"
              style="width:400px !important; height:80px !important;"><?php echo $value; ?>
    </textarea>
<?php }
